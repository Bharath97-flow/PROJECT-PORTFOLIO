...
void dash_display()
{
    ...
    while(time_text[i])
    {
        clcd_write(0x80+2+i,0);
        clcd_write(time_text[i],1);
        i++;
    }
    i=0;
    while(evt[i])
    {
        clcd_write(0x80+10+i,0);
        clcd_write(evt[i],1);
        i++;
    }
    i=0;
    while(speed[i])
    {
        clcd_write(0x80+14+i,0);
        clcd_write(speed[i],1);
        i++;
    }
...
int speed_display()
{
    ...
    while(speed_text[i])
    {
        clcd_write(0xC0 + 14 + i, 0);
        clcd_write(speed_text[i++],1);
    }
